...
CREATE TABLE "frozenWeeks" (
    ...
    CONSTRAINT "frozenWeeks_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "weeklyKilometrage" (
    ...
    CONSTRAINT "weeklyKilometrage_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "trelloProjects" (
    ...
    CONSTRAINT "trelloProjects_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "trelloImportHistory" (
    "id" TEXT NOT NULL,
    "sourceId" TEXT NOT NULL,
    ...
    CONSTRAINT "trelloImportHistory_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "generalSettings" (
    ...
    CONSTRAINT "generalSettings_pkey" PRIMARY KEY ("key")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "frozenWeeks_employeeId_weekStart_key" ON "frozenWeeks"("employeeId", "weekStart");

-- CreateIndex
CREATE UNIQUE INDEX "weeklyKilometrage_employeeId_weekStart_key" ON "weeklyKilometrage"("employeeId", "weekStart");

-- CreateIndex
CREATE UNIQUE INDEX "weeklyObjectives_employeeId_weekStart_key" ON "weeklyObjectives"("employeeId", "weekStart");
...
-- AddForeignKey
ALTER TABLE "employees" ADD CONSTRAINT "employees_statutId_fkey" FOREIGN KEY ("statutId") REFERENCES "statuts"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "trelloImportHistory" ADD CONSTRAINT "trelloImportHistory_sourceId_fkey" FOREIGN KEY ("sourceId") REFERENCES "trelloSources"("id") ON DELETE CASCADE ON UPDATE CASCADE;
