export default function Page() {
  return (
    <main className="mx-auto max-w-200 bg-white p-5 print:p-[15mm] print:text-[11pt]">
      {/* Header */}
      <header className="mb-0 rounded-t-3xl border-0 bg-black px-5 py-3.75 text-center text-white print:rounded-none">
      ...
      {/* Section 1: Pointage */}
      <section className="print:page-break-inside-avoid mb-4 border-black border-r-4 border-b-4 border-l-4 p-0">
        ...
        <ol className="space-y-3 px-5 py-4">
          <li className="relative mb-3 pl-11.25 text-sm before:absolute before:-top-0.5 before:left-0 before:flex before:h-8 before:w-8 before:items-center before:justify-center before:rounded-full before:bg-(--punch-dark) before:font-bold before:text-base before:text-white before:content-['1']">
            <strong>Sélectionner votre nom</strong> dans le menu déroulant sur
            la page d'accueil
          </li>
          <li className="relative mb-3 pl-11.25 text-sm before:absolute before:-top-0.5 before:left-0 before:flex before:h-8 before:w-8 before:items-center before:justify-center before:rounded-full before:bg-(--punch-dark) before:font-bold before:text-base before:text-white before:content-['2']">
          ...
          <li className="relative mb-3 pl-11.25 text-sm before:absolute before:-top-0.5 before:left-0 before:flex before:h-8 before:w-8 before:items-center before:justify-center before:rounded-full before:bg-(--punch-dark) before:font-bold before:text-base before:text-white before:content-['3']">
            <strong>Cliquer sur "Punch In"</strong> pour démarrer le chronomètre
          </li>
          <li className="relative mb-3 pl-11.25 text-sm before:absolute before:-top-0.5 before:left-0 before:flex before:h-8 before:w-8 before:items-center before:justify-center before:rounded-full before:bg-(--punch-dark) before:font-bold before:text-base before:text-white before:content-['4']">
            <strong>Cliquer sur "Terminé"</strong> pour revenir à la page
            principale
          </li>
          <li className="relative mb-3 pl-11.25 text-sm before:absolute before:-top-0.5 before:left-0 before:flex before:h-8 before:w-8 before:items-center before:justify-center before:rounded-full before:bg-(--punch-dark) before:font-bold before:text-base before:text-white before:content-['5']">
